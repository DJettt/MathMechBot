...
final class FullNameTest {
    ...
    static Stream<Arguments> testCorrectData() {
        return Stream.of(
                ...
                Arguments.of("Салтыков-Щедрин Михаил Евграфович", "Салтыков-Щедрин", "Михаил", "Евграфович"),
                Arguments.of("Смит Сара-Джейн", "Смит", "Сара-Джейн", null)
        );
    }
    ...
    @ValueSource(strings = {
            ...
            "Ии- Иванов", "Иванов Ии-", "Иванов Иванов Иванович-Ии"
    })
